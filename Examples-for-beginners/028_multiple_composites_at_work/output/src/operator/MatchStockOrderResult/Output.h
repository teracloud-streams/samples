...
#ifndef SPL_OPER_INSTANCE_MATCHSTOCKORDERRESULT_OUTPUT_H_
#define SPL_OPER_INSTANCE_MATCHSTOCKORDERRESULT_OUTPUT_H_
...
#undef MY_OPERATOR
#endif // SPL_OPER_INSTANCE_MATCHSTOCKORDERRESULT_OUTPUT_H_
